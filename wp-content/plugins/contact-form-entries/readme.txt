...
2. Edit Entry.
3. Entry Notes.
4. Google Analytics Parameters (Premium feature).
5. Get email infomation from Full Contact(Premium feature).
6. Entries Stats on Dashboard.
7. Entries table on front end.
...
= 1.2.6 =
* fixed "select form dropdown" issue.

= 1.2.5 =
* fixed "print entry" issue.
