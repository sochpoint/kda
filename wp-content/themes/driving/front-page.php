...
while (have_posts()) :
    ...
    <section class="home-3-banner-area"
             style="background: url('<?php echo esc_url($banner_image['url']); ?>'); background-position: center; background-size: cover; background-repeat: no-repeat;">
        <div class="container">
            <div class="banner-heading">
                ...
                if ($link) :
                    ...
                    ?>
                    <a class="theme-btn wow fadeInDown" data-wow-duration="3.20s"
                ...
                if ($link) :
                    ...
                    $link_target = $link['target'] ? $link['target'] : '_self';
                    ?>
                    <a class="theme-btn two wow fadeInDown" data-wow-duration="3.20s"
                       href="<?php echo esc_url($link_url); ?>"
                       target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($link_title); ?></a>
                <?php endif; ?>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="funfact-item">
                                    <span class="completeds"><svg width="48" height="50" viewBox="0 0 48 50" fill="none"
                                                                  xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.51063 40.9787V5.46383H34.1936V35.2904L39.6585 30.7766V2.73191C39.6585 1.2234 38.4362 0 36.9277 0H2.77872C1.27021 0 0.0478668 1.2234 0.0478668 2.73191V43.7096C0.0478668 45.2181 1.27021 46.4415 2.77872 46.4415H26.617L22.7553 40.9787H5.51063Z"
                                              fill="#E81D4F"/>
                                        <path d="M47.5245 29.3713C47.0213 28.8968 46.2479 28.8745 45.7181 29.3106L33.1883 39.666L24.8383 34.6564C24.284 34.3245 23.5745 34.4234 23.133 34.9C22.6947 35.3723 22.6468 36.0883 23.0202 36.616L32.0691 49.4213C32.3223 49.7798 32.734 49.9947 33.1723 49.9989C33.1766 49.9989 33.1808 49.9989 33.1851 49.9989C33.6191 49.9989 34.0287 49.7936 34.2862 49.4404L47.6904 31.1713C48.0947 30.617 48.0255 29.8457 47.5245 29.3713Z"
                                              fill="#E81D4F"/>
                                        <path d="M28.0489 9.5617H11.6564C10.1479 9.5617 8.92552 10.7851 8.92552 12.2936C8.92552 13.8021 10.1479 15.0255 11.6564 15.0255H28.0479C29.5564 15.0255 30.7776 13.8021 30.7776 12.2936C30.7776 10.7851 29.5574 9.5617 28.0489 9.5617Z"
                                              fill="#E81D4F"/>
                                        <path d="M28.0489 17.7564H11.6564C10.1479 17.7564 8.92552 18.9798 8.92552 20.4883C8.92552 21.9968 10.1479 23.2202 11.6564 23.2202H28.0479C29.5564 23.2202 30.7776 21.9979 30.7776 20.4883C30.7808 18.9798 29.5574 17.7564 28.0489 17.7564Z"
                                              fill="#E81D4F"/>
                                        <path d="M28.0489 25.9521H11.6564C10.1479 25.9521 8.92552 27.1755 8.92552 28.684C8.92552 30.1926 10.1479 31.416 11.6564 31.416H28.0479C29.5564 31.416 30.7776 30.1926 30.7776 28.684C30.7808 27.1755 29.5574 25.9521 28.0489 25.9521Z"
                                              fill="#E81D4F"/>
                                        </svg>
                                    </span>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 wow fadeInRightBig" data-wow-duration="1.30s">
                    <div class="funfact-text-area">
                        <?php if ($experience_details = get_field('experience_details')) : ?>
                            <?php echo $experience_details; ?>
                        <?php endif; ?>
                            ...
                            <div class="col-lg-3 col-sm-6 wow fadeInUpBig" data-wow-duration="1s">
                                <div class="feature-items text-center">
                                    ...
                                    <span class="rode-with">
                                        ...
                                        <svg width="150" height="93" viewBox="0 0 150 93" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                        <path d="M48.295 62.9802C42.2267 59.9178 34.5881 59.7418 27.795 58.6717C21.471 57.672 9.94548 53.3001 5.34097 48.5621C-2.61743 40.3744 -2.14135 22.4925 9.88863 16.783C23.6879 10.2286 41.0259 16.2479 55.9834 18.191C79.0628 21.1971 84.0226 3.53347 106.47 0.499182C115.053 -0.662437 127.304 1.88609 131.51 10.5454C136.847 21.5421 129.769 34.1721 137.77 44.5985C140.762 48.4987 160.132 64.9092 140.364 71.372C133.287 73.6882 126.025 75.1878 118.791 76.8985C111.827 78.5459 105.063 80.5171 98.8096 84.0231C90.4675 88.6978 81.294 95.6745 71.6871 90.9647C59.3302 84.8961 59.5647 68.6686 48.295 62.9802Z"
                                              fill="#FFA8BF"/>
                                        </svg>
                                    </span>
                                        <span class="shape-two">
                                        <svg width="150" height="116" viewBox="0 0 150 116" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.8328 51.5689C-6.02107 87.7762 39.555 104.44 68.3829 104.44C96.7276 104.44 128.767 93.8448 128.767 61.2843C128.767 -22.5354 58.7831 -10.5813 17.8328 51.5689Z"
                                              fill="#E81D4F"/>
                                        <path d="M49.0838 10.3701C49.0838 12.7215 46.5612 14.6294 43.4418 14.6294C40.3295 14.6294 37.7999 12.7215 37.7999 10.3701C37.7999 8.01871 40.3224 6.11084 43.4418 6.11084C46.5612 6.11084 49.0838 8.01871 49.0838 10.3701Z"
                                              fill="#E81D4F"/>
                                        <path d="M56.0687 2.12616C56.0687 3.30186 54.9886 4.25227 53.6528 4.25227C52.3169 4.25227 51.2368 3.30186 51.2368 2.12616C51.2368 0.950457 52.3169 3.8577e-05 53.6528 3.8577e-05C54.9815 -0.00700154 56.0687 0.950457 56.0687 2.12616Z"
                                              fill="#E81D4F"/>
                                        <path d="M95.4131 116C98.0071 116 100.11 113.917 100.11 111.347C100.11 108.776 98.0071 106.693 95.4131 106.693C92.8191 106.693 90.7162 108.776 90.7162 111.347C90.7162 113.917 92.8191 116 95.4131 116Z"
                                              fill="#E81D4F"/>
                                        <path d="M133.947 87.8043C133.947 89.7896 132.143 91.3948 129.918 91.3948C127.694 91.3948 125.889 89.7896 125.889 87.8043C125.889 85.819 127.694 84.2139 129.918 84.2139C132.143 84.2139 133.947 85.819 133.947 87.8043Z"
                                              fill="#E81D4F"/>
                                        <path d="M124.014 92.8593C124.014 93.5914 123.232 94.1898 122.266 94.1898C121.299 94.1898 120.518 93.5914 120.518 92.8593C120.518 92.1271 121.299 91.5287 122.266 91.5287C123.232 91.5287 124.014 92.1201 124.014 92.8593Z"
                                              fill="#E81D4F"/>
                                        </svg>
                                    </span>
                                    </div>
                            ...
                            <div class="team-id">
                                ...
                                <ul class="team-links text-center">
                                    <?php if (get_field('facebook')): ?>
                                        <li><a href="<?php the_field('facebook'); ?>" target="_blank"><i
                                                        class="fab fa-facebook-f"></i></a></li>
                                    <?php endif ?>
                                    <?php if (get_field('instagram')): ?>
                                        <li><a href="<?php the_field('instagram'); ?>" target="_blank"><i
                    ...
                    <div class="driving-img">
                        <div class="bg-and-play-btn">
                            ...
                            if ($learning_section_image) : ?>
                                <img src="<?php echo esc_url($learning_section_image['url']); ?>"
                                     alt="<?php echo esc_attr($learning_section_image['alt']); ?>"/>
                            <?php endif; ?>
                            <?php if ($learning_section_video_url = get_field('learning_section_video_url')) : ?>
                                <a class="popup-youtube" href="<?php echo esc_url($learning_section_video_url); ?>"><i
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="geallery-image">
                                ...
                                <div class="geallery-link">
                                    <a href="<?php the_post_thumbnail_url(); ?>" class="img-zoom"><i
                        ...
                        while ($loop->have_posts()) : $loop->the_post();
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-heading<?php echo $counter; ?>">
                                    <button class="accordion collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#flush-collapse<?php echo $counter; ?>"
                                            aria-expanded="false"
                                            aria-controls="flush-collapse<?php echo $counter; ?>"><?php the_title(); ?></button>
                                </h2>
                                <div id="flush-collapse<?php echo $counter; ?>" class="accordion-collapse collapse"
                                     aria-labelledby="flush-heading<?php echo $counter ?>"
