            ...
            <div class="row">
                    ...
                    <div class="footer-second-item">
                        ...
                        <ul>
                            ...
                            <?php if ($contact_email = get_field('contact_email', 12)) : ?>
                                <li><a href="mailto:<?php echo esc_html($contact_email); ?>"><span><i
                                                    class="fal fa-envelope-open"></i></span><?php echo esc_html($contact_email); ?>
                                    </a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="1.40s">
                    <div class="footer-four-item">
                        ...
                        <p>
                            <a class="text-white"
                               href="<?php echo get_permalink(3); ?>"><?php echo get_the_title(3) ?></a>
                        </p>
                    </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom-item text-center d-block">
                ...
                <p>
                    <span>&#169;</span><?php echo date('Y'); ?> Kamal's Driving Academy.
                    <?php
