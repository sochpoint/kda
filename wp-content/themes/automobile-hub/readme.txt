...
2. Type in Automobile Hub in the search form and press the 'Enter' key on your keyboard.
...
= 0.1.5 =
    . Added blog on/off option in customizer.
...
= 0.2.3 =
    ...
    . Added Translation.
    . Removed escaping from default.

= 0.2.4 =
    . Added keyboard navigation code.
    . Added link underline.
    . Changed toggle menu css.
...
= 0.2.8 =
    * Changed the search popup CSS.
    * Added prefix in function.php file.
    * Added default WP sanitize_email.
    * Done escaping.

= 0.2.9 =
    * Done minor bug fixes.
    * Removed extra CSS.
...
= 0.3.1 =
    * Added Pre loader functionality.
    * Added hide and show option for prel loader.
...
= 0.3.3 =
    * Added new theme supports.
    * Removed unused CSS.
    * Resolved keyboard navigation menu issue.
...
= 0.3.5 =
    * Added search on - off options.
    * Added theme url code.
...
= 0.4.7 =
    * Updated selective refresh.
    * Added get-started CSS.
...
Automobile Hub WordPress Theme is derived from Twenty Seventeen WordPress Theme, Copyright 2016 WordPress.org
